...
export async function invokeBedrockModel(partner: string, initialKeywords: string[]) {
    ...
    const promptText = `I have a discount platform with partners that can go on different categories: fashion; food & drink; technology; beauty; travel & lifestyle; wellbeing; health & fitness. 
    ...
    const requestBody = claudeRequestTemplate.replace('{{PROMPT_TEXT}}', promptText);
